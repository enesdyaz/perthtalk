...
function Feed() {
  ...
  useEffect(()=>{
    if(user === undefined){
      ...
      if(user.currentUser.admin === null || user.currentUser.admin == undefined || user.currentUser.admin == false){
        setAdmin(false)
      }else
      setAdmin(true)
    }
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <main>
          {/* 메인  */}
          <div className="px-0 sm:px-6 lg:px-8 py-8 md:py-0 w-full max-w-9xl mx-auto">
                      ...
                      <div className="bg-white shadow-md rounded border border-slate-200 p-5">
                        <div className="flex items-center space-x-3 mb-5 ">
                          ...
                          <div className="grow">
                            ...
                            <div
                              className="form-input w-full bg-slate-100 text-slate-600 border-transparent focus:bg-white focus:border-slate-300 placeholder-slate-500"
                              
                            >현재 베타버전 v.11 <br />호주에 사시는 분들의 이야기를 오픈톡과 블로깅을 조합하여 만든 앱입니다. 많은 관심 부탁드립니다<br />운영자를 모집하오니 관심있으신 분들은 알려주세요  </div>
                          </div>
                        </div>
                        <div className="flex justify-between items-center">
                          ...
                          <div>
                            <Link to="/ecommerce/Pay" className={admin?`btn-sm bg-indigo-500 hover:bg-indigo-600 text-white whitespace-nowrap`:`btn-sm bg-indigo-200 hover:bg-indigo-300 text-white whitespace-nowrap btn-disabled` }  >
                              글쓰기 -&gt;
                            </Link>
                          </div>
                        </div>
