...
function AppsPanel() {
  ...
  const addAdmin = (data) => {
    console.log('addAdmin', data.email);
  ...
  const deleteAdmin = (data) => {
    console.log('deleteAdmin', data.email);
    // const functions = getFunctions();
    // const deleteAdminRole = httpsCallable(functions, "deleteAdminRole");
    // deleteAdminRole({ email: data.email }).then(result => {
    //   console.log('result', result)
    // })
  }
  return (
    <div className="grow">
      ...
      {/* Panel body */}
      <div className="p-6">
        <h2 className="text-2xl text-slate-800 font-bold mb-5">사용자 어드민 세팅</h2>
              ...
              <div className="flex flex-col h-full p-5">
                <div className="grow">
                  <header className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg text-slate-800 font-semibold">이메일로 어드민 설정</h3>
                  </header>
                  <form>
                    <div className="space-y-4">
                      <div>
                        <label className="block text-sm font-medium mb-1" htmlFor="email">Email Address</label>
                        <input {...register("email", {required: true})} id="email" className="form-input w-full" type="email" />
                      </div>
                    </div>
                    <div className="flex items-center justify-end mt-2">
                      <button type="button"  className="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-3" >관리자로 지정</button>
                      <button type="button"  className="btn bg-orange-500 hover:bg-orange-600 text-white ml-3" >관리자 해제</button>
                    </div>
                  </form>
